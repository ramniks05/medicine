...
<body>
  ...
  <div class="page-wrapper">
   ...
   <h1  class="main-heading">Vendor Registration - Partner with us</h1>
      ...
      <div  class="row">
         <div  class="col-sm-3 col-xs-12">
            <div  class="form-group">
               <label  for=""> Company / Firm Name</label><input  type="text" name="cName"  placeholder="Firm Name" class="form-control ng-untouched ng-pristine ng-invalid"><!---->
            </div>
         </div>
         <div  class="col-sm-3 col-xs-12">
            <div  class="form-group">
               <label  for="">Proprietor /Authorized Name </label><input  type="text"  name="aName"  placeholder="Authorized Name" class="form-control ng-untouched ng-pristine ng-invalid"><!---->
            </div>
         </div>
         <div  class="col-sm-3">
            <div  class="form-group">
